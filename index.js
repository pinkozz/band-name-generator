...
app.post("/submit", (req, res) => {
  ...
  const randomAdj = adj[Math.round(Math.random() * adj.length)];
  const randomNoun = noun[Math.round(Math.random() * noun.length)];
  res.render("index.ejs", {
    displayAdj: randomAdj,
    displayNoun: randomNoun,
  })
});
